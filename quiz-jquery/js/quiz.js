...
let randomIndex = Math.floor(Math.random()*theme.length);
let number = 0;
let score = 0;
...
const change = document.getElementById('chang');
...
function thaydoi(){
	// console.log(chan);
	randomIndex++;
	$('body').css('background-image','url('+theme[randomIndex%theme.length]+')');
